	...
	<div class="container mt-5">
		<div class="card shadow-lg bg-white p-2" style="width:50%; margin: auto;">
			<div class="card-body">
				...
				<h6 align="center" style="text-transform: uppercase; color: #85929E;">Sigin into your account</h6>
				<hr/>
				...
				<form action="process.php" method="POST" id="form">
					...
					<div class="form-group mb-2">
						<center>
							<button name="login" class="btn btn-dark" type="submit" class="form-control"><i class="fa fa-sign-in"></i>	Login</button>
							<p class="mt-2"><a class="text-dark" href="reset.php">Forgot Password?<a></p>
							<p>Don't have an account? <a class="text-dark" style="font-weight: 600;" href="register.php">Register <a></p>
						</center>
