                                ...
                                <div class="card-body">
                                    ...
                                    <form action="../process.php" method="POST" id="form" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group mb-4">
                                            ...
                                            <input type="file" name="banquet_image" required class="form-control">
                                        </div>
                                        ...
                                        <div class="form-group mb-4">
                                            <center>
                                                <button type="submit" class="btn btn-success mt-2" name="addBanquetOwner"><i class="fa fa-hotel"></i> Add Banquet</button>
                                            </center>
                                        </div>
