                        ...
                        <div class="container-fluid mt-2">
                            <div class="card shadow-sm p-3 mb-5 bg-white">
                                ...
                                <ol class="breadcrumb mb-2">
                                    <li class="breadcrumb-item active"><i class="fa fa-map-marker"></i>  Add Location</li>
                                </ol>
                                <div class="card-body">
                                    <?php 
                                    ...
                                    <form action="../process.php" method="POST" id="form">
                                        <div class="form-group mb-4">
                                            ...
                                            <input type="text" minlength="4" maxlength="20" name="location" required placeholder="Enter location name" class="form-control">
                                        </div>


                                         <div class="row mb-2">
                                            <div class="col-md-12 col-xs-12 col-sm-12">
                                                <strong>Location Status <span class="text-danger">*</span></strong>
                                        ...
                                        <div class="form-group mb-4">
                                            <center>
                                                <button type="submit" class="btn btn-success mt-2" name="addlocation"><i class="fa fa-plus-circle"></i> Add Location</button>
                                            </center>
                                        </div>
