                                ...
                                <div class="card-body">
                                    ...
                                    <form action="../process.php" method="POST" id="form">
                                        <div class="form-group mb-4">
                                            ...
                                            <input value="<?php echo $_SESSION['admin']['username']?>" type="text" minlength="4" maxlength="20" name="username" required placeholder="Enter your full name" class="form-control">
                                        </div>

                                    
                                        <div class="form-group mb-4">
                                            <strong>Email Address <span class="text-danger">*</span></strong>
                                            <input value="<?php echo $_SESSION['admin']['email']?>" type="email" minlength="4" maxlength="40" name="email" required placeholder="Enter your valid email" class="form-control">
                                            <p style="font-size: 14px;" class="text-success">please provide valid email</p>
                                        </div>

                                        <div class="form-group mb-4">
                                            <center>
                                                <button type="submit" class="btn btn-success" name="UpdateProfile"><i class="fa fa-edit"></i> Update</button>
                                            </center>
                                        </div>
